        ...
        {featured && (
          <div className="mb-12">
            ...
            <div className="flex justify-end mt-3 mb-5">
              <Link href={`/products/${featured.slug}`} className="text-[13px] font-semibold no-underline border-b border-ink pb-[2px]">
                See more &#8594;
              </Link>
            </div>
            ...
            {rest.map((cs) => (
              <div key={cs._id} className="flex flex-col gap-3.5">
                ...
                <div className="flex justify-end -mt-3">
                  <Link href={`/products/${cs.slug}`} className="text-[13px] font-semibold no-underline border-b border-ink pb-[2px]">
                    See more &#8594;
                  </Link>
                </div>
                <div>
